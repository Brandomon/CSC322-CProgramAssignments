...
int main(int argc, char **argv)
{
    ...
    printf("ARGUMENT LIST INITIALIZATION SUCCESS\n");
    ...
    printf("EMPTY CACHE INITIALIZED OF SIZE %i Lines X %i Sets\n", numLines, numSets);
    ...
    printf("NON NULL FILE OPENED SUCCESSFULLY\n");
    ...
    hexAddress = malloc(addressSize * sizeof(char));

    printf("HEX ADDRESS MALLOC SUCCUESS\n");
    ...
    printf("CLOCK TIME COUNTER INITIALIZE SUCCESS\n");
...
// --- Receives char array in the form of a hexidecimal representation and converts it to binary string
// --- of the length addressSize and returns the resulting binary char array
// ****************************************************************************************************
